...
2. The mixin, during the prepare phase, prepare the interaction callables.
...
The evolution of the temperature and its decay is governed by an evolutor. Same for inertia and its evolution dumped by friction.
"""
